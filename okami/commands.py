...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("background", "run a task in parallel and notify you when it's done", "session",
               ("bg",), args="<task>"),
    CommandDef("goal", "persistent goal for this chat (judge tracks progress; /goal clear|done)",
               "session", ("objetivo",), args="[text|clear|done]"),
    CommandDef("subgoal", "add a step to the active goal (closed only with concrete evidence)",
               "session", args="<text>"),
