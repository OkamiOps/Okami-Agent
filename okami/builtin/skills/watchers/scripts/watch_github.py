...
Usage:
    ...
    python3 watch_github.py --name okami-issues --repo owner/repo --scope issues

Set the GitHub credential described in SKILL.md to avoid the 60 req/hr
anonymous rate limit (read via _gh_auth.py, kept separate from this
file's network calls — see that module's docstring for why).
