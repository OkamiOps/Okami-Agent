...
description: Todo o conhecimento de animação do HyperFrames — regras atômicas de motion, blueprints de cena multi-fase, transições, técnicas de motion design, e os runtime adapters (GSAP padrão, Lottie, Three.js, Anime.js, CSS keyframes, Web Animations API, TypeGPU). Use pra qualquer tarefa de motion/animação.
triggers: [animação, motion design, gsap, lottie, three.js, keyframes, transição de cena, timeline de animação, waapi]
intent_examples:
  - "anima esse título com GSAP"
  - "que transição usar entre essas duas cenas"
  - "monta uma cena com Three.js pro vídeo"
metadata:
  source: https://github.com/heygen-com/hyperframes (skills/hyperframes-animation)
  hermes:
    tags: [video, animation, motion-design, gsap, hyperframes]
    related_skills: [hyperframes, hyperframes-creative]
    category: creative
---
