---
name: seo-audit
description: "Auditoria de SEO — crawlability, tecnico, on-page, conteudo, autoridade. Framework de prioridade + limitacao de deteccao de schema (JS-injected) + checklist acionavel. Fonte: coreyhaines31/marketingskills."
triggers: [seo, auditoria seo, seo tecnico, nao to rankeando, trafego caiu, core web vitals, indexacao, meta tags, seo audit]
intent_examples:
  - "minha SEO ta ruim, faz uma auditoria"
  - "por que eu sumi do Google?"
  - "revisa os meta tags e o core web vitals do site"
  - "cai o trafego organico, investiga"
---
