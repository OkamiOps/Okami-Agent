...
description: Skill anti-clichê pra landing pages, portfólios e redesigns — lê o brief, infere a direção certa de design e entrega interfaces que não parecem template de IA. Sistema de design real quando cabe, auditoria antes de redesign, checklist rígido de pré-voo. Não é pra dashboard/tabela de dados/UI de produto multi-etapa.
triggers: [landing page, portfolio, redesign, cara de ia, parece templado, anti-clichê, brutalist, awwwards, site premium, one-pager]
intent_examples:
  - "cria uma landing page que não pareça feita por IA"
  - "redesenha esse portfólio, tá genérico"
  - "quero um site estilo Awwwards pro meu produto"
  - "audita esse redesign antes de mandar pro cliente"
metadata:
  source: https://github.com/leonxlnx/taste-skill (skills/taste-skill)
  hermes:
    tags: [frontend, design, landing-page, portfolio, anti-slop, taste]
    related_skills: [frontend-design, design-systems]
    category: creative
---
