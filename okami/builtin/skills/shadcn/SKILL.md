---
name: shadcn
description: Gerencia componentes e projetos shadcn/ui — adicionar, buscar, corrigir, depurar, estilizar e compor UI, incluindo interfaces de chat. Dá contexto do projeto, docs de componente e exemplos de uso. Aplica quando o projeto usa shadcn/ui, registries de componente, presets, ou tem `components.json`.
triggers: [shadcn, shadcn/ui, components.json, registry de componente, --preset, radix, componente ui react]
intent_examples:
  - "adiciona um componente de tabela com shadcn"
  - "esse formulário não segue o padrão shadcn, corrige"
  - "cria um app novo com --preset"
  - "por que esse Dialog do shadcn não fecha certo"
metadata:
  source: https://github.com/shadcn-ui/ui (skills/shadcn)
  hermes:
    tags: [shadcn, ui, react, radix, components, frontend]
    related_skills: [frontend-design, vercel-react-best-practices, ui-ux-pro-max]
    category: creative
---
