...
Usage:
    python scripts/grade.py <input> -o <output>                   # auto mode
    python scripts/grade.py <input> -o <output> --preset warm_cinematic
    python scripts/grade.py <input> -o <output> --filter 'eq=contrast=1.1'
    python scripts/grade.py --print-preset warm_cinematic         # print filter only
    python scripts/grade.py --analyze <input>                     # print auto-grade analysis
