...
Usage:
    python scripts/transcribe_batch.py <videos_dir>
    python scripts/transcribe_batch.py <videos_dir> --workers 4
    python scripts/transcribe_batch.py <videos_dir> --num-speakers 2
    python scripts/transcribe_batch.py <videos_dir> --edit-dir /custom/edit
"""
...
from _scribe_auth import load_credential
