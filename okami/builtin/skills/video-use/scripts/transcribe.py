...
Usage:
    ...
    python scripts/transcribe.py <video_path> --edit-dir /custom/edit
    python scripts/transcribe.py <video_path> --language en
    python scripts/transcribe.py <video_path> --num-speakers 2

Credential loading lives in _scribe_auth.py (kept separate from this network path —
...
from _scribe_auth import HEADER_NAME, load_credential
...
def transcribe_one(
    ...
    with tempfile.TemporaryDirectory() as tmp:
        ...
        payload = call_scribe(audio, credential, language, num_speakers)
