...
Usage:
    python scripts/timeline_view.py <video> <start> <end>
    python scripts/timeline_view.py <video> <start> <end> -o out.png
    python scripts/timeline_view.py <video> <start> <end> --n-frames 12
    python scripts/timeline_view.py <video> <start> <end> --transcript <path>
    python scripts/timeline_view.py --edl <edl.json>   (full-project view — not yet)
"""
