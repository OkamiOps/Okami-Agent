---
name: humanizer-blader
description: "Remove padroes de escrita de IA (tiques do Wikipedia:Signs of AI writing) — em-dash, vocabulario de IA, regra de 3, listas com cabecalho em negrito, tom servil. Mais denso que a humanizer nativa; guarda de falsos-positivos incluso. Fonte: blader/humanizer."
triggers: [humanizer, humanizar, ai writing, em dash, cheira a ia, parece gerado por ia, tom robotico, remover clichés de ia]
intent_examples:
  - "isso aqui cheira a texto de IA, limpa pra mim"
  - "tira os em-dashes e o vocabulario de IA desse texto"
  - "reescreve isso com uma voz mais humana, mas sem perder nada do conteudo"
  - "calibra pelo meu jeito de escrever, aqui vai uma amostra"
---
...
## Nota sobre a skill `humanizer` nativa

Existe uma skill `humanizer` pt-BR mais enxuta (clichês comuns + fluxo draft→audit→final).
Esta é a versão mais densa (baseada em Wikipedia:Signs of AI writing, 30+ padrões
catalogados com antes/depois, mais uma seção inteira de falsos-positivos pra não
"limpar" texto humano de verdade). Mantida como skill distinta por ser
significativamente mais rica — puxe esta quando o texto for longo/importante o
suficiente pra merecer um raio-x completo.

Fonte: [blader/humanizer](https://github.com/blader/humanizer).
