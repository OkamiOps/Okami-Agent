...
description: "Dev loop do HyperFrames CLI (npx hyperframes) — init/scaffold, lint/validate/inspect, preview/render, doctor/browser, Lambda cloud render. Requer Node.js >= 22 + FFmpeg. Fonte: heygen-com/hyperframes."
triggers: [hyperframes, npx hyperframes, render video composicao, lint hyperframes, validate hyperframes, hyperframes lambda, studio timeline]
intent_examples:
  - "roda o lint e o validate nessa composicao hyperframes"
  - "renderiza isso em qualidade alta com hyperframes"
  - "faz o render na nuvem via hyperframes lambda"
  - "o ambiente do hyperframes ta quebrado, roda o doctor"
---
