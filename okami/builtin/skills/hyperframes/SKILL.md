---
name: hyperframes
description: Skill de entrada pra qualquer pedido de criar, editar, animar ou renderizar vídeo/animação/motion graphic — promo, explicador, clipe legendado, title card, overlay, slideshow. HyperFrames renderiza vídeo a partir de HTML. Leia isto ANTES de qualquer outra skill de vídeo/animação — ela roteia pro workflow certo. Depende do CLI `npx hyperframes` e das skills-irmãs `hyperframes-creative`/`hyperframes-animation` (também portadas).
triggers: [video, vídeo, animação, motion graphic, promo em video, explicador em video, legenda em video, hyperframes, renderizar video]
intent_examples:
  - "faz um vídeo de lançamento pro meu produto"
  - "cria uma animação curta desse dado"
  - "transforma esse PR num vídeo de changelog"
  - "bota legenda nesse vídeo de talking head"
metadata:
  source: https://github.com/heygen-com/hyperframes (skills/hyperframes)
  hermes:
    tags: [video, animation, motion-graphics, router, hyperframes]
    related_skills: [hyperframes-creative, hyperframes-animation]
    category: creative
---
