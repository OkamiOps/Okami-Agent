...
from okami.core.tools.remote import RemoteAdd, RemoteConnect, RemoteDisconnect
...
def default_registry() -> dict[str, Tool]:
    tools = [Respond(), ReadFile(), WriteFile(), EditFile(), ApplyPatch(), ListDir(), FindFiles(),
             ...
             UseSkill(), ManageSkill(), InstallSkill(), SearchSkills(), Spawn(), SpawnJobs(), MixtureOfAgents(),
